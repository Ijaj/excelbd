...
export const sendParcelNotification = async (parcel: ParcelDocument) => {
  const emailContent = `
    ...
    <p><strong>Estimated Delivery:</strong> ${
      parcel.dates?.estimated ? parcel.dates.estimated : "Not set"
    }</p>
    ...
    <p>Track your parcel at: <a href="${process.env.FRONTEND_URL}/track/${
